...
const TEMPLATE = `<div class="dp-container">
  <div class="dp-header">
    <div class="dp-item dp-left xy-datetime-cancel" data-role="cancel">cancel</div>
    <div class="dp-item xy-datetime-clear" data-role="clear"></div>
    <div class="dp-item dp-right xy-datetime-confirm" data-role="confirm">ok</div>
  </div>
...
DatetimePicker.prototype = {
  ...
  _show (newValueMap) {
    ...
    if (this.renderInline) {
      self.container.classList.add('xy-datetime-view')
    }
