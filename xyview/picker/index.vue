<template>
  <div class="xy-picker">
    <xy-flexbox :gutter="0">
      <xy-flexbox-item :span="columnWidth && columnWidth[index]" v-for="(one, index) in currentData" :key="index" style="margin-left:0;">
        <div class="xy-picker-item" :id="`xy-picker-${uuid}-${index}`"></div>
      </xy-flexbox-item>
    </xy-flexbox>
  </div>
</template>
